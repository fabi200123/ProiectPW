...
<body style="background-color: #004528;">
	...
	<h2 style="text-align: center;color: #fff;">Editeaza Informatiile</h2>
	<?php
	...
	<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1= "UPDATE client SET pic='$pic', first='$first', last='$last', username='$username', password='$password', email='$email', contact='$contact' WHERE username='".$_SESSION['login_user']."';";
